# https://github.com/dremdeveloper/codingtest_python/blob/main/solution/33.py
...
# 이 문제에서 루트 노드의 개수를 구하는 문제이므로 'f'연산자는 의미 없음
print(solution(3,[['u', 0, 1], ['u', 1, 2], ['f', 2]])) # 반환값 : 1
print(solution(4,[['u', 0, 1], ['u', 2, 3], ['f', 0]])) # 반환값 : 2
print(solution(10,[['u', 0, 1], ['u', 2, 3], ['f', 0]])) # 반환값 : 8